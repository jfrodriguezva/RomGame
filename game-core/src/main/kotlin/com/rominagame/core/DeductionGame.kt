...
class DeductionGame(private val domino:Boolean,private val onComplete:(String,Int,Int)->Unit={_,_,_->}):ApplicationAdapter(){
 ...
 override fun create(){shapes=ShapeRenderer();batch=SpriteBatch();font=BitmapFont().apply{data.setScale(1.15f)};reset();Gdx.input.inputProcessor=object:InputAdapter(){
