...
> se restauró la última base Android/Compose completa. LibGDX y Godot quedan
> fuera del artefacto 1.0.0 hasta que una migración futura alcance paridad
> funcional y visual verificable con estas pantallas.
