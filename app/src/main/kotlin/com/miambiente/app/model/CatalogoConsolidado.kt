...
val FAMILIAS = listOf(
    ...
    familia("numeros-cantidades","Números y cantidades","🔢","Conteo, sistema decimal, tiempo y fracciones",Categoria.NUMEROS,"contar","husos","barras-numericas","numeros","tabla-cien","banco-dorado","pares-impares","reloj","mitades",motor=Motor.LIBGDX),
    familia("clasifica-mundo","Clasifica el mundo","🧺","Seres vivos, alimentos, agua, día y transportes",Categoria.MUNDO,"seres-vivos","habitat","dieta-animal","fruta-verdura","estados-agua","dia-noche","transporte",motor=Motor.LIBGDX),
